...
const repoName = "modelcontextprotocol-suite";

export const modelcontextprotocolSuiteRepositoryGit = new RepositoryGithub(`${repoName}-repository`, {
...
// export const modelcontextprotocolSuiteMainTrigger = new Trigger(`${repoName}-main-trigger`, {
