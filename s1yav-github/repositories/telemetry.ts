...
const repoName = "telemetry";

export const telemetryRepositoryGit = new RepositoryGithub(`${repoName}-repository`, {
...
export const telemetryMainTrigger = new Trigger(`${repoName}-main-trigger`, {
    projectId: gcpConfig.require("project"),
    location: gcpConfig.require("region"),
    repository: telemetryRepositoryGit.repository.id,
    branchFilter: "^main$",
