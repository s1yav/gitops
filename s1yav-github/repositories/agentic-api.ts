...
const repoName = "agentic-api";

export const agenticApiRepositoryGit = new RepositoryGithub(`${repoName}-repository`, {
...
export const agenticApiMainTrigger = new Trigger(`${repoName}-main-trigger`, {
    projectId: gcpConfig.require("project"),
    location: gcpConfig.require("region"),
    repository: agenticApiRepositoryGit.repository.id,
    branchFilter: "^main$",
